            ...
            <div id="content ">
                ...
                <div class="container-fluid mt-5">
                    ...
                    <div class="text-center">
                        ...
                        <p class="lead text-gray-800 mb-5">File Not Found!!</p>
                        <p class="text-gray-500 mb-0">Renek file e lurr.. balik wae ya!!</p>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; SD Muhammadiyah Karanganyar 2019</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->

...
class Home extends CI_Controller
{
    ...
    public function login()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('templates/auth_header_login');
    ...
    private function _login()
    {
        ...
        if ($user) {
            ...
            if ($user['is_active'] == 1) {
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Has not been activation!! Please activate!</div>');
                redirect('home/login');
            }
        } else {
